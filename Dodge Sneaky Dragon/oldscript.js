...
setInterval(() => {
  ...
  const freezeObstaclePositionXaxis = window
  ...
  // console.log("horse left value", dx);
  // console.log("horse top value", dy);
  console.log("ox", ox);
  if (ox < -130) {
    console.log("inside ox", ox);
    console.log("working");
  ...
  // console.log("dragon top value", oy);
  ...
  if (offsetX < 150 && offsetY < 52) {
    obstacle.style.left = freezeObstaclePositionXaxis;
    console.log("Obstacle", ox);
